...
namespace Avatars
{
    ...
    /// the <see cref="AvatarGeneratorAttribute"/> and reports unsupported pointer types 
    ...
    public class PointerMemberAnalyzer : DiagnosticAnalyzer
    {
        ...
        /// with <see cref="AvatarGeneratorAttribute"/>.
        /// </summary>
        public PointerMemberAnalyzer() : this(typeof(AvatarGeneratorAttribute)) { }
