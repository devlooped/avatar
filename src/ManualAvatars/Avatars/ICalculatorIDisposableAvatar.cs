...
{
    [CompilerGenerated]
    partial class ICalculatorIDisposableAvatar : ICalculator, IDisposable, IAvatar
    {
        readonly BehaviorPipeline pipeline = BehaviorPipelineFactory.Default.CreatePipeline<ICalculatorIDisposableAvatar>();

        [CompilerGenerated]
        public ICalculatorIDisposableAvatar() => pipeline.Execute(MethodInvocation.Create(this, MethodBase.GetCurrentMethod(), (m, n) => m.CreateReturn()));
