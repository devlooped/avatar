...
namespace Avatars
{
    // Source: https://github.com/dotnet/roslyn/blob/main/src/Workspaces/SharedUtilitiesAndExtensions/Compiler/Core/Extensions/ISymbolExtensions_Accessibility.cs#L16
    static partial class ISymbolExtensions
    {
        /// <summary>
        ...
        /// type" check.
        /// </summary>
        static bool IsSymbolAccessible(
            ISymbol symbol,
            INamedTypeSymbol within,
        ...
        static bool IsSymbolAccessibleCore(
            ISymbol symbol,
        ...
        // an assembly.
        static bool IsNamedTypeAccessible(INamedTypeSymbol type, ISymbol within)
        {
            Debug.Assert(within is INamedTypeSymbol || within is IAssemblySymbol);
        ...
        static bool IsNonNestedTypeAccessible(
        ...
        static bool IsMemberAccessible(
        ...
        static bool IsProtectedSymbolAccessible(
        ...
        static bool IsPrivateSymbolAccessible(
            ISymbol within,
            INamedTypeSymbol originalContainingType)
        {
            Debug.Assert(within is INamedTypeSymbol || within is IAssemblySymbol);
        ...
        static bool IsNestedWithinOriginalContainingType(
            INamedTypeSymbol withinType,
            INamedTypeSymbol originalContainingType)
        {
            ...
            {
                Debug.Assert(current.IsDefinition);
                if (SymbolEqualityComparer.Default.Equals(current, originalContainingType))
                {
                    return true;
                }
