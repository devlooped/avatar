...
namespace Avatars
{
    ...
    /// the avatar.
    /// </summary>
    public class AvatarDocumentGenerator
    {
        ...
        /// used for example when using the default constructor <see cref="AvatarDocumentGenerator()"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes the generator with the default <see cref="Avatar.NamingConvention"/> 
        /// and the <see cref="GetDefaultProcessors"/> default processors.
        /// </summary>
        public AvatarDocumentGenerator() : this(new NamingConvention(), DefaultProcessors) { }

        /// <summary>
        /// Initializes the generator with a custom <see cref="Avatar.NamingConvention"/> and 
        /// the <see cref="GetDefaultProcessors"/> default processors.
        /// </summary>
        public AvatarDocumentGenerator(NamingConvention naming) : this(naming, DefaultProcessors) { }

        /// <summary>
        /// Initializes the generator with the default <see cref="Avatar.NamingConvention"/> 
        /// and the given set of <see cref="IDocumentProcessor"/>s.
        /// </summary>
        public AvatarDocumentGenerator(params IDocumentProcessor[] processors) : this(new NamingConvention(), (IEnumerable<IDocumentProcessor>)processors) { }

        /// <summary>
        /// Initializes the generator with the default <see cref="Avatar.NamingConvention"/> 
        /// and the given set of <see cref="IDocumentProcessor"/>s.
        /// </summary>
        public AvatarDocumentGenerator(IEnumerable<IDocumentProcessor> processors) : this(new NamingConvention(), processors) { }

        /// <summary>
        /// Initializes the generator with a custom <see cref="Avatar.NamingConvention"/> and 
        /// the given set of <see cref="IDocumentProcessor"/>s.
        /// </summary>
        public AvatarDocumentGenerator(NamingConvention naming, IEnumerable<IDocumentProcessor> processors)
        {
        ...
        /// <summary>
        /// Attribute used to flag a generic method as avatar-generating,
        /// meaning invocations to that method are used to trigger source generation.
        /// </summary>
        public Type GeneratorAttribute { get; protected set; } = DefaultGeneratorAttribute;

        /// <summary>
        /// Generates a avatar document that implements the given types.
        /// </summary>
        /// <remarks>
        /// This aggregating method basically invokes <see cref="CreateAvatar(IEnumerable{INamedTypeSymbol}, SyntaxGenerator)"/> 
        ...
        public async Task<Document> GenerateDocumentAsync(Project project, ITypeSymbol[] types, CancellationToken cancellationToken = default)
        {
            ...
            var (name, syntax) = CreateAvatar(types.OfType<INamedTypeSymbol>(), generator);
        ...
        /// <summary>
        /// Generates the empty avatar code as a <see cref="SyntaxNode"/>, also returning 
        ...
        /// </summary>
        public (string name, SyntaxNode syntax) CreateAvatar(IEnumerable<INamedTypeSymbol> symbols, SyntaxGenerator generator)
        {
